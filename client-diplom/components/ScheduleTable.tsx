...
import { useScheduleStore } from '@/store/scheduleStore'; // Подключите типы, где они у вас расположены
...
const ScheduleTable: React.FC = () => {
  ...
  const groupedSchedule = schedule.reduce((acc: Record<number, Schedule[]>, item) => {
              ...
              <Table.Root>
                ...
                {groupedSchedule[Number(dayNumber)].map((item, index) => (
                  ...
                  >
                    ...
                    <Table.Cell className="font-medium">{item.discipline.name}</Table.Cell>
